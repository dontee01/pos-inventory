...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="col-lg-12">
            ...
            <form action="{{url('filter/show')}}" method="post">
            {{csrf_field()}}
 ...
 <!-- <input name="dayfrom" type="text" class="tcal" required="required" autocomplete="off" /> -->
                ...
                <div class="form-group form-group-lg">
                    <select class="input-lg " name="report_type" required="required">
                ...
                <div class="form-group form-group-lg">
                    <select class="input-lg " title="Select an item" name="item_id" required="required">
                        <option value="">Select an item</option>
                        @foreach($items as $item)
                            <option value="{{ $item->id }}">{{ $item->i_name }}</option>
                        @endforeach
                    </select>
                    <span class="help-block lgall">Select an item</span>
                </div>
