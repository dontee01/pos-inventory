    ...
    <section class="content bg-default">
       ...
       <!-- Display Validation Errors -->
        ...
        <div class="panel-body">
            <div class="">
                <div class=form-group>
                 <input class="form-control" type="text" name="name" id="add-user-name" placeholder="Username" title="Username" required="required" />
                </div>
            </div>
        ...
        <div class="panel-body">
            <div class="">
                <div class=form-group>
                 <input class="form-control" type="text" name="password" id="add-user-password" placeholder="****" title="Password" required="required" />
                </div>
            </div>
        ...
        <div class="panel-body">
            <div class="">
                <div class=form-group>
                    <select class="form-control" name="level" id="add-user-level" required="required">
